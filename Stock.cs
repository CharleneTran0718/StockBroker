...
namespace Stock
{
    ...
    public class Stock
    {
        ...
        public Stock(string name, int startingValue, int maxChange, int threshold)
        {
            ...
            this._thread = new Thread(new ThreadStart(Activate)); // starts a new thread to simulate changes in stock values
            _thread.Start(); // initiates execution of the thread
        }
        //-------------------------------------------------------------------------------
        /// <summary>
